...
config.read('C:/Bases de Datos Multidimensionales/Datawarehouse_SmartsTV/datawarehouse/ETL/secrets.ini')
...
try:
    df = pd.read_csv('C:/Bases de Datos Multidimensionales/Datawarehouse_SmartsTV/data/smarts_dataset.csv')
